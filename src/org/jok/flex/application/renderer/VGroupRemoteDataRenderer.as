...
package org.jok.flex.application.renderer
{
	 ...
	 */
	public class VGroupRemoteDataRenderer extends GroupRemoteDataRenderer implements IRemoteDataRenderer {
		 ...
		 *  @productversion Flex 4
		 */  
		public function VGroupRemoteDataRenderer():void
		{
			super();
		...
		override public function initializeWithRemote( helper : IFormViewHelper,	data : Object, field : XML) : void {
